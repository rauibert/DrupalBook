  ...
  CKEDITOR.plugins.add('widgetbootstrap', {
    ...
    init(editor) {
      ...
      editor.widgets.add('widgetbootstrapLeftCol', {
        ...
        template: '<div class="row two-col-left">' + '<div class="col-sm-3 col-md-3 col-sidebar"><p><img src="https://picsum.photos/300/250?random=1" /></p></div>' + '<div class="col-sm-9 col-md-9 col-main"><p>Content</p></div>' + '</div>',
        editables: {
          col1: {
      ...
      editor.widgets.add('widgetbootstrapRightCol', {
        ...
        template: '<div class="row two-col-right">' + '<div class="col-sm-9 col-md-9 col-main"><p>Content</p></div>' + '<div class="col-sm-3 col-md-3 col-sidebar"><p><img src="https://picsum.photos/300/250?random=2" /></p></div>' + '</div>',
        editables: {
          col1: {
            selector: '.col-sidebar'
          },
      ...
      editor.widgets.add('widgetbootstrapTwoCol', {
        ...
        template: '<div class="row two-col">' + '<div class="col-6 col-sm-6 col-md-6 col-first"><p><img src="https://picsum.photos/500/280?random=3" /></p><p>Content</p></div>' + '<div class="col-6 col-sm-6 col-md-6 col-second"><p><img src="https://picsum.photos/500/280?random=4" /></p><p>Content</p></div>' + '</div>',
        editables: {
          col1: {
            selector: '.col-first'
          },
      ...
      editor.widgets.add('widgetbootstrapThreeCol', {
        ...
        template: '<div class="row three-col">' + '<div class="col-4 col-sm-4 col-md-4 col-first"><p><img src="https://picsum.photos/400/225?random=5" /></p><p>Text below</p></div>' + '<div class="col-4 col-sm-4 col-md-4 col-second"><p><img src="https://picsum.photos/400/225?random=6" /></p><p>Text below</p></div>' + '<div class="col-4 col-sm-4 col-md-4 col-third"><p><img src="https://picsum.photos/400/225?random=7" /></p><p>Text below</p></div>' + '</div>',
        editables: {
          col1: {
            selector: '.col-first'
          },
